...
・多指ハンドロボットは古くから開発されてきた Adroit\cite{kumar2014real}など？\\
・近年は Shadowなど本格的なロボットも \\
%%% もう一種類挙げたい．
・一方で，低コストなトイロボットであるRobel\cite{ahn2020robel}，LEAP hand\cite{shaw2023leap}などが強化学習の研究に向く．\\
